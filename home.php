...
<?php
	...
	if(is_array($arrTables) && count($arrTables)) {
		...
		foreach($tg as $tn => $tgroup) {
			...
			$tChkAHAN = array_search($tn, ['servers','operating_systems','hosting_providers','data_centers','domains','subdomains','registrars','dns_managers','mail_providers','clients','client_contacts']);
